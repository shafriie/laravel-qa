...
<head>
	...
	<link rel="shortcut icon" sizes="196x196" href="{{ asset('secrets/assets') }}/images/logo.png">
	<title>LAR Project</title>
	
	<link rel="stylesheet" href="{{ asset('secrets/libs') }}/bower/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="{{ asset('secrets/libs') }}/bower/material-design-iconic-font/dist/css/material-design-iconic-font.css">
	<!-- build:css ../assets/css/app.min.css -->
	<link rel="stylesheet" href="{{ asset('secrets/libs') }}/bower/animate.css/animate.min.css">
	<link rel="stylesheet" href="{{ asset('secrets/libs') }}/bower/fullcalendar/dist/fullcalendar.min.css">
	<link rel="stylesheet" href="{{ asset('secrets/libs') }}/bower/perfect-scrollbar/css/perfect-scrollbar.css">
	...
	<link rel="stylesheet" href="{{ asset('secrets/assets') }}/css/app.css">
	<!-- endbuild -->
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:400,500,600,700,800,900,300">
	<script src="{{ asset('secrets/libs') }}/bower/breakpoints.js/dist/breakpoints.min.js"></script>
	<script>
		Breakpoints();
	</script>
</head>
...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="../index.html" class="navbar-brand">
      ...
      <span class="brand-name">LAR Project</span>
    </a>
  </div><!-- .navbar-header -->
          ...
          <div class="media-group dropdown-menu animated flipInY">
              ...
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('secrets/assets') }}/images/221.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('secrets/assets') }}/images/205.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('secrets/assets') }}/images/207.jpg" alt="">
            ...
            <a href="javascript:void(0)" class="media-group-item">
              <div class="media">
                <div class="media-left">
                  <div class="avatar avatar-xs avatar-circle">
                    <img src="{{ asset('secrets/assets') }}/images/211.jpg" alt="">
                    <i class="status status-away"></i>
                  </div>
                </div>
                <div class="media-body">
    ...
    <div class="media">
      <div class="media-left">
        <div class="avatar avatar-md avatar-circle">
          <a href="javascript:void(0)"><img class="img-responsive" src="{{ asset('secrets/assets') }}/images/221.jpg" alt="avatar"/></a>
        </div><!-- .avatar -->
      </div>
      <div class="media-body">
        <div class="foldable">
						...
						<div class="media-group feeds-group">
								...
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-sm avatar-circle">
											<img src="{{ asset('secrets/assets') }}/images/217.jpg" alt="">
										</div>
									</div>
									<div class="media-body">
							...
							<div class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-sm avatar-circle">
											<img src="{{ asset('secrets/assets') }}/images/218.jpg" alt="">
										</div>
									</div>
									<div class="media-body">
							...
							<div class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-sm avatar-circle">
											<img src="{{ asset('secrets/assets') }}/images/219.jpg" alt="">
										</div>
									</div>
									<div class="media-body">
							...
							<div class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-sm avatar-circle">
											<img src="{{ asset('secrets/assets') }}/images/215.jpg" alt="">
										</div>
									</div>
									<div class="media-body">
						...
						<div class="streamline m-l-lg">
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
									<img class="img-responsive" src="{{ asset('secrets/assets') }}/images/221.jpg" alt="avatar"/>
								</div><!-- .avatar -->
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
									<img class="img-responsive" src="{{ asset('secrets/assets') }}/images/214.jpg" alt="avatar"/>
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
									<img class="img-responsive" src="{{ asset('secrets/assets') }}/images/217.jpg" alt="avatar"/>
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
									<img class="img-responsive" src="{{ asset('secrets/assets') }}/images/211.jpg" alt="avatar"/>
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
...
<!--========== END app main -->
			...
			<div class="media-group">
				...
				<a href="javascript:void(0)" class="media-group-item">
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-xs avatar-circle">
								<img src="{{ asset('secrets/assets') }}/images/206.jpg" alt="">
								<i class="status status-online"></i>
							</div>
						</div>
						<div class="media-body">
				...
				<a href="javascript:void(0)" class="media-group-item">
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-xs avatar-circle">
								<img src="{{ asset('secrets/assets') }}/images/208.jpg" alt="">
								<i class="status status-away"></i>
							</div>
						</div>
						<div class="media-body">
				...
				<a href="javascript:void(0)" class="media-group-item">
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-xs avatar-circle">
								<img src="{{ asset('secrets/assets') }}/images/209.jpg" alt="">
								<i class="status status-away"></i>
							</div>
						</div>
						<div class="media-body">
				...
				<a href="javascript:void(0)" class="media-group-item">
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-xs avatar-circle">
								<img src="{{ asset('secrets/assets') }}/images/210.jpg" alt="">
								<i class="status status-offline"></i>
							</div>
						</div>
						<div class="media-body">
				...
				<a href="javascript:void(0)" class="media-group-item">
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-xs avatar-circle">
								<img src="{{ asset('secrets/assets') }}/images/212.jpg" alt="">
								<i class="status status-offline"></i>
							</div>
						</div>
						<div class="media-body">
	...
	<script src="{{ asset('secrets/libs') }}/bower/jquery/dist/jquery.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/jquery-ui/jquery-ui.min.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/jQuery-Storage-API/jquery.storageapi.min.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/bootstrap-sass/assets/javascripts/bootstrap.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/jquery-slimscroll/jquery.slimscroll.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/perfect-scrollbar/js/perfect-scrollbar.jquery.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/PACE/pace.min.js"></script>
	<!-- endbuild -->

	<!-- build:js ../assets/js/app.min.js -->
	<script src="{{ asset('secrets/assets') }}/js/library.js"></script>
	<script src="{{ asset('secrets/assets') }}/js/plugins.js"></script>
	<script src="{{ asset('secrets/assets') }}/js/app.js"></script>
	<!-- endbuild -->
	<script src="{{ asset('secrets/libs') }}/bower/moment/moment.js"></script>
	<script src="{{ asset('secrets/libs') }}/bower/fullcalendar/dist/fullcalendar.min.js"></script>
	<script src="{{ asset('secrets/assets') }}/js/fullcalendar.js"></script>
</body>
</html>